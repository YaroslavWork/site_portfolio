...
class Skill(models.Model):
    ...
    stuff_i_know: list[MultiLanguageString] = models.ManyToManyField(
        MultiLanguageString,
        related_name='skills_know',
        help_text="The translatable items I know related to the skill"
    )
    stuff_i_learn: list[MultiLanguageString] = models.ManyToManyField(
        MultiLanguageString,
        related_name='skills_learn',
        help_text="The translatable items I am learning related to the skill"
    )
    stuff_i_plan: list[MultiLanguageString] = models.ManyToManyField(
        MultiLanguageString,
